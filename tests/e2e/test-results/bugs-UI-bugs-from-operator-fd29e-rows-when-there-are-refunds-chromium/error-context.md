...
- Name: bugs.spec.ts >> UI bugs from operator review >> swap state filter "refunded" returns rows when there are refunds
- Location: bugs.spec.ts:60:3
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      ...
      - generic [ref=e19]:
        ...
        - button "completed" [ref=e22]
        - button "refunded" [active] [ref=e23]
